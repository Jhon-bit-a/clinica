            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="max-w-lg mx-auto">
                    ...
                    <form action="{{route('receta.store')}}" method="POST">
                        ...
                        <div class="mb-6">
                            <label for="cantidad" class="text-sm font-medium text-gray-900 block mb-2">
                                cantidad:
                            </label>
                        ...
                        <div class="mb-6">
                            <label for="nombre_receta" class="text-sm font-medium text-gray-900 block mb-2">
                                nombre receta:
                            </label>
                            <input type="text" id="nombre_receta" name="nombre_receta"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="nombre receta" value=" {{old('nombre_receta')}} ">
                        </div>
                        @error('nombre_receta')
                        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
                            role="alert">
                        ...
                        <div class="mb-6">
                            <label for="detalle" class="text-sm font-medium text-gray-900 block mb-2">
                                detalle:
                            </label>
                            <input type="text" id="detalle" name="detalle"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="detalle" value=" {{old('detalle')}} ">
                        </div>
                        @error('detalle')
                        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
                            role="alert">
