                ...
                <div class="max-w-lg mx-auto">
                    ...
                    <form action="{{route('cargo.update', $cargo)}}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input value=" {{old('nombre', $cargo->nombre)}} " type="text" id="nombre" name="nombre"
                        ...
                        <div class="mb-6">
                            <label for="usuario" class="text-sm font-medium text-gray-900 block mb-2">usuario:</label>
                            <input value=" {{old('usuario', $cargo->usuario)}} " type="text" id="usuario" name="usuario"
                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500
                            focus:border-blue-500 block w-full p-2.5"  required="">
                        </div>

                        <div class="mb-6">
                            <label for="clave" class="text-sm font-medium text-gray-900 block mb-2">clave:</label>
                            <input value=" {{old('clave', $cargo->clave)}} " type="text" id="clave" name="clave"
                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500
                            focus:border-blue-500 block w-full p-2.5"  required="">
                        </div>
