            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="max-w-lg mx-auto">
                    ...
                    <form action="{{route('servicio.update', $servicio)}}" method="POST">
                        ...
                        <div class="mb-6">
                            <label for="nombreservicio" class="text-sm font-medium text-gray-900 block mb-2">
                                nombre servicio:
                            </label>
                            <input value=" {{old('nombreservicio', $servicio->nombreservicio)}} " type="text" id="nombreservicio" name="nombreservicio"
