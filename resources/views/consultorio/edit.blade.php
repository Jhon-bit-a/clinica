            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="max-w-lg mx-auto">
                    ...
                    <form action="{{route('consultorio.update', $consultorio)}}" method="POST">
                        ...
                        <div class="mb-6">
                            <label for="n_consultorio" class="text-sm font-medium text-gray-900 block mb-2">
                                n_consultorio:</label>
                            <input value=" {{old('n_consultorio', $consultorio->n_consultorio)}} " type="text" id="n_consultorio" name="n_consultorio"
                        ...
                        <div class="mb-6">
                            <label for="idenfermeria" class="text-sm font-medium text-gray-900 block mb-2">
                                idenfermeria:
                            </label>
