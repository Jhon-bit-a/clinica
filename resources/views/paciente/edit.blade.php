                ...
                <div class="max-w-lg mx-auto">
                    ...
                    <form action="{{route('paciente.update', $paciente)}}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input value=" {{old('nombres', $paciente->nombres)}} " type="text" id="nombres" name="nombres"
                        ...
                        <div class="mb-6">
                            ...
                            <input value=" {{old('apellidos', $paciente->apellidos)}} " type="text" id="apellidos" name="apellidos"
                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500
                            focus:border-blue-500 block w-full p-2.5"  required="">
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <input value=" {{old('direccion', $paciente->direccion)}} " type="text" id="direccion" name="direccion"
                            class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500
                            focus:border-blue-500 block w-full p-2.5"  required="">
                        </div>
