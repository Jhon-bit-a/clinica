                    ...
                    <form action="{{route('paciente.store')}}" method="POST">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="nombres" name="nombres"
                                ...
                                placeholder="Ingrese el nombres" value=" {{old('nombres')}} ">
                        </div>
                        @error('nombres')
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="apellidos" name="apellidos"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="Ingrese el apellidos" value=" {{old('apellidos')}} ">
                        </div>
                        @error('apellidos')
                        <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative"
                            role="alert">
                        ...
                        <div class="mb-6">
                            <label for="fecha_nacimiento" class="text-sm font-medium text-gray-900 block mb-2">fecha nacimiento:</label>
                            <input type="date" id="fecha_nacimiento" name="fecha_nacimiento"
                                class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                                placeholder="Ingrese el fecha_nacimiento" value=" {{old('fecha_nacimiento')}} ">
                        </div>
                        ...
                        <div class="mb-6">
                            <label for="genero" class="text-sm font-medium text-gray-900 block mb-2">
							genero:
							</label>
